...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Έχετε υπερβεί το όριο προσπαθειών αλλαγής κωδικού πρόσβασης. Αναμείνατε πριν ξαναπροσπαθήσετε.',
    ...
    login: {
      ...
      'lock.mfa_registration_required': 'Απαιτείται ταυτοποίηση δύο βημάτων. Παρακαλούμε καταχορύστε την συσκευή σας πριν συνεχίσετε.',
      'lock.mfa_invalid_code': 'Λάθος κωδικός. Παρακαλώ προσπαθήστε ξανά.',
      password_change_required: 'Πρέπει να αντικαταστήσετε τον κωδικό πρόσβασής σας, επειδή πρωτοσυνδέεστε ή ο κωδικός σας έχει λήξει.',
      password_leaked: 'Εντοπίσαμε πιθανό πρόβλημα ασφαλείας στον λογαριασμό σας. Για να τον προστατεύσουμε, τον απενεργοποιήσαμε. Αποστείλαμαι email με οδηγίες επανενεργοποίησης',
  ...
  passwordlessSMSInstructions: 'Για να συνδεθείτε εισαγάγετε τοv αριθμό κινητού σας <br/> ή δημιουργήστε έναν λογαριασμό',
